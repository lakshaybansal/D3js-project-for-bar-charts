  ...
  function processSampleFile(inputFile) {
    ...
    rl.on('close', function (line) {
      ...
      for(var i=0;i<15; ++i){
        ...
        var temp = parseFloat(resultfinal[i]["GDP_Per_Capita_2005"]);

        obj["growth1"] = parseInt(temp);

        temp = parseFloat(resultfinal[i]["GNI_Per_Capita_2005"]);
      ...
      fs.writeFile('data2.json', JSON.stringify(g15,null,2),  function(err) {
         if (err) {
